 ...
 * 佛祖保佑！永无bug
 */
public class RealcomTCPServer {
    private static RealcomTCPServer realcomTCPServer;
    private static Logger logger = LogManager.getLogManager().getLogger(RealcomTCPServer.class.getName());

    public static RealcomTCPServer getInItStance() {
        if (realcomTCPServer == null) {
            return realcomTCPServer = new RealcomTCPServer();
        }
        return realcomTCPServer;
    }
    ...
    public void startServer() {
      /*  Properties properties=new Properties();
        ...
        try {
            ...
            System.out.println("RealcomTCPServer 启动了");
