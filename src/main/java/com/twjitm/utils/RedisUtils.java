...
public class RedisUtils {
    ...
    static {
        ...
        try {
            properties.load(new FileInputStream(new File(RedisUtils.class.getClass().getResource("/").getPath() + "redis/redis.properties")));
    ...
    private static final RedisUtils jedisUtil = new RedisUtils();
    ...
    public static void main(String[] args) {
        ...
        System.out.println(redisUtils.getClass().getResource("/").getPath() + "redis/redis.properties");
